...
**仍待后续 Milestone：** 正式 Port/adapter/schema 插座化；逐镜头/逐资产依赖图；请求级账本、context pack、Agent tree、Token/墙钟可观察性；币种与真实账单；新故事小规模 canary、完整生产验证和用户验收。
...
**Milestone 3 尚未完成：** M3-3C 尚未开始，M3-Z 尚未开始，真实新故事 Canary 尚未运行；不得把 M3-3B 工程封箱表述为整个 M3 或真实供应商产品质量完成。
