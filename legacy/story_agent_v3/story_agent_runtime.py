...
def worktree_binding_issues(payload: Any, expected_root: Path | None = None) -> list[str]:
    ...
    root = (expected_root or Path(__file__).resolve().parents[2]).resolve()
    issues: list[str] = []
...
STAGE_ESTIMATES_MINUTES = {
    ...
    "artifact_semantic_plan": 1,
    "visual_samples": 12,
    "visual_sample_review": 8,
...
STORY_STAGE_DEPENDENCIES: dict[str, tuple[str, ...]] = {
    ...
    "artifact_semantic_plan": ("story_contract_review",),
    "visual_samples": ("artifact_semantic_plan",),
    "visual_sample_review": ("visual_samples",),
    "codex_story_images": ("visual_sample_review",),
...
STAGE_BRANCHES = {
    ...
    **{name: "contract" for name in ("story_contract", "story_contract_review", "artifact_semantic_plan")},
    **{name: "visual" for name in ("visual_samples", "visual_sample_review", "codex_story_images", "story_images_review", "prepare_jobs", "timing", "video_prompt_review", "generate_videos", "video_qa", "video_review", "apply_review")},
...
STAGE_WRITE_SETS = {
    ...
    "artifact_semantic_plan": ("status/story_contract/artifact_semantic_plan",),
    "visual_samples": ("status/visual_samples",),
    "visual_sample_review": ("status/visual_samples", "status/reviews/visual_sample"),
