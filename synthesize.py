...
def main() -> None:
    ...
    parser.add_argument("--sales-skip-head-lines", default=2, type=int, help="销售版字幕跳过开头台词行数")
    parser.add_argument("--sales-skip-tail-lines", default=1, type=int, help="销售版字幕跳过结尾台词行数")
